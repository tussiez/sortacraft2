...
const SortaCanvas = {
  ...
  collision: function (obj, obj2) {
    if (obj != undefined && obj2 != undefined) {
      ...
      if (
        bounds.min.x < bounds2.max.x && bounds.max.x > bounds2.min.x &&
        bounds.min.y < bounds2.max.y && bounds.max.y > bounds2.min.y
      ) {
        return true; //Collide
      } else {
  ...
  render: function () {
    ...
    if (this.ready == true) {
      ...
      for (let i = 0; i < ln; i++) {
        if (
          this.objects[i].drawLast == undefined ||
          this.objects[i].drawLast == false
        ) {
          this.objects[i].draw();
        } else {
  ...
  Move: function (obj, x2, y2, time) {
    if (this.tween != false) {
      ...
      let tween = new this.TWEEN.Tween(fr).to(to, time * 1000).onUpdate(
        function () {
          obj.x = fr.x;
          obj.y = fr.y;
        },
  ...
  Rectangle: function (x, y, h, w, c, n) {
    ...
    this.type = "rectangle";
    if (
      typeof x != "number" || typeof y != "number" || typeof h != "number" ||
      typeof w != "number" || typeof c != "string" || h < 0 || w < 0
    ) {
      if (SortaCanvas.strictMode == true) {
        SortaCanvas.throwError(
    ...
    this.draw = function () {
      if (
        ...
        typeof this.height != "number" || typeof this.width != "number" ||
        typeof this.color != "string" || this.height < 0 || this.width < 0 ||
  ...
  Circle: function (x, y, r, c, n) {
    ...
    this.type = "circle";
    if (
      typeof x != "number" || typeof y != "number" || typeof r != "number" ||
      typeof c != "string" || r < 0
    ) {
      if (SortaCanvas.strictMode == true) {
        SortaCanvas.throwError(
    ...
    this.draw = function () {
      if (
        typeof this.x != "number" || typeof this.y != "number" ||
        typeof this.color != "string" || typeof this.radius != "number" ||
        this.radius < 0
      ) {
        SortaCanvas.throwError(
          "One or more variables are not of their expected types, or are undefined. This error will also be thrown if any arguments are negative.",
  ...
  Image: function (x, y, h, w, s, n) {
    ...
    if (this.img != undefined) {
      ...
      let imge = undefined;
      let response = fetch(s).then((response) => response.blob()).then(
        (blob) => {
    ...
    if (
      typeof x != "number" || typeof y != "number" || typeof h != "number" ||
      typeof w != "number" || typeof s != "string" || h < 0 || w < 0
    ) {
      if (SortaCanvas.strictMode == true) {
        SortaCanvas.throwError(
          "One or more variables are not of their expected types, or are undefined. This error will also be thrown if any arguments are negative.",
    ...
    this.draw = function () {
      if (
        typeof this.x != "number" || typeof this.y != "number" ||
        typeof this.height != "number" || typeof this.width != "number" ||
        this.height < 0 || this.width < 0 || typeof this.rotation != "number"
      ) {
        SortaCanvas.throwError(
          "One or more variables are not of their expected types, or are undefined. This error will also be thrown if any arguments are negative.",
        );
  ...
  Text: function (x, y, t, font, s, str, n) {
    ...
    this.rotation = 0;
    if (
      typeof font != "string" || typeof x != "number" || typeof y != "number" ||
      typeof t != "string" || typeof s != "string" || typeof str != "boolean"
    ) {
      if (SortaCanvas.strictMode == true) {
        SortaCanvas.throwError(
    ...
    this.draw = function () {
      if (
        typeof this.font != "string" || typeof this.x != "number" ||
        typeof this.y != "number" || typeof this.text != "string" ||
        typeof this.style != "string" || typeof this.stroke != "boolean" ||
        typeof this.rotation != "number"
      ) {
        SortaCanvas.throwError(
          "One or more variables are not of their expected types, or are undefined. This error will also be thrown if any values are negative.",
        ...
        if (this.rotation == 0) {
          ...
          SortaCanvas.ctx.fillText(
            this.text,
            -this.width / 2,
            -this.height / 2,
          );
          if (this.stroke == true) {
            SortaCanvas.ctx.strokeText(
              this.text,
              -this.width / 2,
              -this.height / 2,
            );
