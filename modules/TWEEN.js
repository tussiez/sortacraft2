...
(function (global, factory) {
  ...
  (function (exports) {
      ...
      Elastic: {
        ...
        Out: function (amount) {
          ...
          return Math.pow(2, -10 * amount) *
              Math.sin((amount - 0.1) * 5 * Math.PI) + 1;
        },
        InOut: function (amount) {
          if (amount === 0) {
            return 0;
    ...
    if (
      ...
      typeof self !== "undefined" && self.performance !== undefined &&
    ...
    var Tween = /** @class */ (function () {
      ...
      Tween.prototype._setupProperties = function (
        ...
        for (var property in _valuesEnd) {
          ...
          var isInterpolationList = !startValueIsArray &&
            Array.isArray(_valuesEnd[property]);
          ...
          if (
            (propType === "object" || startValueIsArray) && startValue &&
            !isInterpolationList
          ) {
            ...
            if (isInterpolationList) {
              // eslint-disable-next-line
              // @ts-ignore FIXME?
              _valuesStartRepeat[property] = _valuesEnd[property].slice()
                .reverse();
            } else {
        ...
        if (elapsed === 1) {
          if (this._repeat > 0) {
            ...
            for (property in this._valuesStartRepeat) {
              if (
                !this._yoyo && typeof this._valuesEnd[property] === "string"
              ) {
