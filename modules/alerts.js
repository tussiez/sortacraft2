...
const Alerts = {
  alert: function (msg) {
    ...
    child.innerHTML =
      "<h1 style='margin-top:5px;margin-bottom:3px;text-align:center;'>Alert!</h1><p style='margin-top:5px;margin-left:10px;color:gray;'>" +
      msg + "</p><div style='text-align:center;'><button id='dismissAlert" +
      alertNum +
      "' style='background-color:lightblue;bottom:4px;right:50px;width:30%;height:30px;color:white;border-radius:1px;border:none;margin-bottom:6px;'>Ok</button></div>";
    parent.appendChild(child);
    document.body.appendChild(wrapper);
    document.getElementById("dismissAlert" + alertNum).addEventListener(
      "click",
      function () {
  ...
  alertBanner: function (
    ...
    opacity,
    zIndex,
    timeToShow, /*In seconds*/
  ) {
    if ("undefined" === typeof msg) {
      throw new TypeError('Parameter "msg" (argument 1) is not defined!');
    }
    ...
    banner.style = "background-color: " + backgroundColor +
      ";color:white;opacity:" + opacity + ";text-align:center;z-index:" +
      zIndex + ";position:fixed;width:100%;top:0;left:0;";
